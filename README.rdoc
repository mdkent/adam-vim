...
To use the gist plugin 

git config --global github.user <user>
git config --global github.token <api key from account info>

For complete support install

* ctags
* atk
* RedCloth

Compile command-t support
...
[,b] = FuzzyBufferFinder
[,d] = Toggle NERDtree
[,F] = LustyFilesystemExplorer
[,f] = FuzzyFinderFile
[,r] = FuzzyFinderMruFile
[,R] = LustyFilesystemExplorerFromHere 
[,l] = TListToggle 
[,s] = RunSpec
[,S] = RunSpecs
[,gd] = git diff
